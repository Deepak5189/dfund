...
const donors = [
  { initials: "RK", gradient: "linear-gradient(135deg, #C0442A, #E8820C)", name: "Rahul Kumar", time: "2 hours ago", amount: "+$100" },
  { initials: "AN", gradient: "linear-gradient(135deg, #4A6741, #7DB56A)", name: "Anjali Nair", time: "5 hours ago", amount: "+$25" },
  { initials: "DV", gradient: "linear-gradient(135deg, #7B5EA7, #B09FD4)", name: "Dr. Dev Verma", time: "1 day ago", amount: "+$250" },
  { initials: "MS", gradient: "linear-gradient(135deg, #1A6B6B, #3AAFA9)", name: "Meera Sharma", time: "1 day ago", amount: "+$50" },
  { initials: "A", gradient: "linear-gradient(135deg, #2D5A8E, #5B9BD5)", name: "Anonymous", time: "2 days ago", amount: "+$500" },
];
    ...
    <div style={{ position: "sticky", top: "85px", height: "fit-content" }}>
      ...
      <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", borderTop: "1px solid #E2D9CC", marginBottom: "24px" }}>
            {[
              ...
              <div key={stat.label} style={{
                ...
                <div style={{ fontSize: "0.7rem", color: "#8A7B6E", marginTop: "2px" }}>{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ padding: "0 28px 28px" }}>
          <div style={{ fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "#8A7B6E", marginBottom: "10px" }}>
            Choose an amount
          </div>
            ...
            {amounts.map((amt) => (
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  boxShadow: selected === amt ? "0 4px 16px rgba(232,130,12,0.25)" : "none",
                }}
              >
                ${amt}
              </button>
          ...
          <div style={{ position: "relative", marginBottom: "20px" }}>
            <span style={{ position: "absolute", left: "14px", top: "50%", transform: "translateY(-50%)", fontWeight: 600, color: "#8A7B6E", fontSize: "0.9rem" }}>$</span>
            <input
              type="number"
              ...
              style={{
                ...
                color: "#8A7B6E", background: "#F7F3ED", outline: "none",
              }}
            />
          </div>
          ...
          <button style={{
            ...
            background: "#E8820C", color: "#1A1410",
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "6px", fontSize: "0.75rem", color: "#8A7B6E" }}>
        ...
        {/* Share row */}
        <div style={{
          borderTop: "1px solid #E2D9CC", padding: "18px 28px",
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            ...
            {["𝕏", "💬", "f", "🔗"].map((icon) => (
              <div key={icon} style={{
                ...
                fontSize: "0.9rem", cursor: "pointer", background: "#F7F3ED",
              }}>
                {icon}
              </div>
            ))}
      ...
      <div style={{
        background: "white", borderRadius: "16px",
        border: "1px solid #E2D9CC", marginTop: "20px", overflow: "hidden",
      }}>
        <div style={{
          padding: "18px 22px", borderBottom: "1px solid #E2D9CC",
          display: "flex", alignItems: "center", justifyContent: "space-between",
        }}>
        ...
        <button style={{
          ...
          background: "#F7F3ED", border: "none", borderTop: "1px solid #E2D9CC",
